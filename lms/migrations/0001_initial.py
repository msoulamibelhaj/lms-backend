    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson_class', models.CharField(default='General', max_length=255)),
            ],
        ),
        migrations.CreateModel(
            name='School',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pin', models.CharField(max_length=4, validators=[django.core.validators.RegexValidator('^\\d{4}$', 'PIN must be a 4-digit number.')])),
                ...
                ('school', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='lms.school')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.school')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='lesson',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='lms.school'),
        ),
        migrations.CreateModel(
            name='Class',
            fields=[
        ...
        migrations.AddField(
            model_name='lesson',
            name='session',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lessons', to='lms.session'),
        ),
    ]
